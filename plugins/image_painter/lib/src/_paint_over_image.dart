...
class ImagePainterState extends State<ImagePainter> {
  ...
  Widget _paintImage() {
    return Stack(children: [
      ...
      if (widget.showControls) Align(
        alignment: widget.controlsAtTop ? Alignment.topCenter : Alignment.bottomCenter,
  ...
  Widget _buildControls() {
    ...
    final safeBottom = MediaQuery.of(context).padding.bottom + 10;
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(30),
        color: widget.controlsBackgroundColor ?? Colors.grey[200],
      ),
      margin: EdgeInsets.fromLTRB(25, safeTop, 25, safeBottom),
      ...
      child: Row(
        children: [
          ...
          PopupMenuButton(
            ...
            icon:
                widget.brushIcon ?? Icon(Icons.brush, color: widget.optionColor ?? Colors.grey[700]),
          ...
          IconButton(
            tooltip: textDelegate.undo,
            icon: widget.undoIcon ?? Icon(Icons.reply, color: widget.optionColor ?? Colors.grey[700]),
            onPressed: () {
              widget.onUndo?.call();
              _controller.undo();
            },
          ...
          IconButton(
            tooltip: textDelegate.clearAllProgress,
            icon: widget.clearAllIcon ??
                Icon(Icons.refresh, color: widget.optionColor ?? Colors.grey[700]),
            onPressed: () {
              widget.onClear?.call();
              _controller.clear();
            },
          ...
          IconButton(
            tooltip: textDelegate.clearAllProgress,
            icon: widget.clearAllIcon ??
                Icon(Icons.close, color: widget.optionColor ?? Colors.grey[700]),
            onPressed: () {
              widget.onClear?.call();
              _controller.clear();
              widget.onClose?.call();
